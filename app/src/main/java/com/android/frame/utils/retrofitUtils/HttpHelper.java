...
public final class HttpHelper {
    ...
    private HttpHelper() {
        //缓存路径
        mCacheFile = new File(RetrofitUtil.getContext().getCacheDir().getAbsolutePath() + File.separator + "retrofit2_http_cache");
        //判断缓存路径是否存在
    ...
    private Interceptor createHttpInterceptor() {
        return new Interceptor() {
            ...
            public okhttp3.Response intercept(Chain chain) throws IOException {
                ...
                boolean isNetwork = isNetworkConnected(RetrofitUtil.getContext());
