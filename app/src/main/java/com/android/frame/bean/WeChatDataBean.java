...
public class WeChatDataBean {
    ...
    @SerializedName("unknown error") private String _$UnknownError140; // FIXME check this code
    ...
    public SenderBean getSender() { return sender;}

    public void setSender(SenderBean sender) { this.sender = sender;}

    public String getError() { return error;}

    public void setError(String error) { this.error = error;}

    public String get_$UnknownError140() { return _$UnknownError140;}

    public void set_$UnknownError140(String _$UnknownError140) { this._$UnknownError140 = _$UnknownError140;}
    ...
    public static class CommentsBean {
        ...
        public SenderBeanX getSender() { return sender;}

        public void setSender(SenderBeanX sender) { this.sender = sender;}
    ...
    public String toString() {
        return "WeChatDataBean{" + "content='" + content + '\'' + ", sender=" + sender + ", error='" + error + '\'' + ", _$UnknownError140='" + _$UnknownError140 + '\'' + ", images=" + images + ", comments=" + comments + '}';
    }
}
